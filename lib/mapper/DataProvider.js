...
class DataProvider {
  constructor () {
    ...
    this.layers = [
      { id: '1', type: 'communication', label: 'Fiber', color: 'gray', icon: 'lens', points: 5, objects: 20 },
      ...
      { id: '4', type: 'equipment', label: 'WIFI access point', color: 'darkblue', icon: 'lens', points: 1, objects: 333 },
