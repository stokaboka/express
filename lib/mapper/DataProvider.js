...
class DataProvider {
  constructor () {
    ...
    this.layers = [
      { id: '1', type: 'communication', label: 'Fiber', color: 'gray', icon: 'lens' },
      // { id: '2', type: 'communication', label: 'Cooper', color: 'green', icon: 'lens' },
      // { id: '3', type: 'communication', label: 'Air', color: 'blue', icon: 'lens' },
      { id: '4', type: 'equipment', label: 'WIFI access point', color: 'darkblue', icon: 'lens' },
  ...
  createObject (layer, objectNum) {
    ...
    const out = {
      ...
      color: layer.color,
      icon: layer.icon,
      points: this.generatePointsByType(layer.type)
    }
  ...
  generateObjects (layer) {
    ...
    for (let o = 0; o < this.numObjectsPerLayer; o++) {
      let object = this.createObject(layer, o)
      objects[o] = object
    }
