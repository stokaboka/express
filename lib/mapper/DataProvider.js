...
class DataProvider {
  constructor () {
    ...
    this.layers = [
      { id: '1', type: 'communication', label: 'Fiber', color: 'gray', icon: 'lens', points: 2, objects: 1 },
      // { id: '2', type: 'communication', label: 'Cooper', color: 'green', icon: 'lens' },
      // { id: '3', type: 'communication', label: 'Air', color: 'blue', icon: 'lens' },
      { id: '4', type: 'equipment', label: 'WIFI access point', color: 'darkblue', icon: 'lens', points: 1, objects: 1 },
