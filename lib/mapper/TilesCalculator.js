...
const { Mercator, DecartPoint } = require('./Mercator')
...
class TilesCalculator {
  ...
  meterToPixels (meterPoint) {
    ...
    let y = Math.round((this.equatorHalfLength - meterPoint.y) * this.pixelsByMeter)
  ...
  pixelsToMeter (pixelPoint) {
    ...
    let y = this.equatorHalfLength - pixelPoint.y / this.pixelsByMeter
